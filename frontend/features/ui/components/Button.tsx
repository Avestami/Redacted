...
const Button: React.FC<ButtonProps> = ({
  ...
  const base = "relative inline-flex items-center justify-center font-bold font-mono transition-all focus:outline-none disabled:opacity-50 disabled:pointer-events-none uppercase tracking-wide group overflow-hidden";
  const variants = {
